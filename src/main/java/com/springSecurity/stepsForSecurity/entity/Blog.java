...
public class Blog {
    ...
    private LocalDateTime createdAt; // Add this field // Date and time when the blog was created
    ...
    private List<Comment> comments; // Comments on the blog (another class representing comments)
